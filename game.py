...
def run_game(config):
    ...
    #save_every = 10
        with writer.as_default():  # Make sure to use the writer you created for TensorBoard
            tf.summary.scalar('Cumulative Reward', tot_reward, step=i)  # Log the cumulative reward for this episode
